...
├── 📤 extract_ranked.py             # Экспорт комментариев по рангам
...
- `comments_rank_0.json` - комментарии с низким рангом (0.0)
- `comments_rank_1.json` - комментарии с высоким рангом (1.0)

### 📄 Текстовые файлы
- `extracted_rank_1_comments.txt` - лучшие комментарии в удобном формате
...
```bash
# Разделение комментариев по рангам
docker-compose run --rm comments-downloader python extract_ranked.py

# Экспорт лучших комментариев в текстовый файл
docker-compose run --rm comments-downloader python extract_ranked_text.py
```
...
**Текущая версия**: v2.1 (Критические исправления + утилиты экспорта)  
...
- ✅ Экспорт в JSON и текстовые файлы
- ✅ Утилиты разделения комментариев по рангам
- ✅ Docker-контейнеризация
- ✅ Система управления лимитами API
- ✅ Исправления Gemini API v1alpha
